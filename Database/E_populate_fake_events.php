...
$query = "INSERT INTO event_main (event_name, description, beg_date_time, end_date_time, event_cost, submitted_by, event_URL, admin_notes, event_loc_lat, event_loc_lng, event_loc_desc, event_address_line1, event_address_line2, event_address_line3) VALUES ('GoGreen', '$descr', '2015-03-10 17:30:00', '2015-03-10 20:00:00', 0.00, 4, '', '', 47.611389,-122.331680, 'Washington State Convention Center', '800 Convention Pl Seattle', '', 'Seattle, WA  98101');";
//echo $query."<br><br>";
prcSQL($mysqli, $query);
...
$query = "INSERT INTO event_main (event_name, description, beg_date_time, end_date_time, event_cost, submitted_by, event_URL, admin_notes, event_loc_lat, event_loc_lng, event_loc_desc, event_address_line1, event_address_line2, event_address_line3) VALUES ('sHell No!', '$descr', '2015-06-06 06:30:00', '2015-06-06 08:30:00', 0.00, 3, '', '', 47.570912,-122.331680, 'Terminal 5 Harbor Island', '123 Harbor Way', '', 'Seattle, WA  98134');";
prcSQL($mysqli, $query);
